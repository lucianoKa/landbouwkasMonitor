...
{
    public class MasterGridView : KryptonDataGridView   // DataGridView
    {
        ...
        public MasterGridView()
        {
            ...
            // Disable Selection
            SelectionChanged += MasterGridView_SelectionChanged;
        ...
        private void MasterGridView_SelectionChanged(object sender, EventArgs e)
        {
            MasterGridView grid = (MasterGridView)(sender);
            grid.ClearSelection();
        }
        ...
        private void InitializeComponent()
        {
            ...
            ComponentResourceManager resources = new ComponentResourceManager(typeof(MasterGridView));
        ...
        private void OpenDetail(int rowIndex)
        {
            ...
            else
            {
                ...
                {
                    this.Rows[rowIndex].Height = 160; // rowExpandedHeight / 2;
