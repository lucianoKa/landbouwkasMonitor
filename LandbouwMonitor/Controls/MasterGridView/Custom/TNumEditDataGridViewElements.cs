...
namespace LBM.Controls.MasterGridView
{
    ...
    public class TNumEditDataGridViewCell : DataGridViewTextBoxCell
    {
        ...
        protected override bool SetValue(int rowIndex, object value)
        {
            ...
            try
            {
                val = Math.Round(Convert.ToDecimal(value), m_decimalLength);
            }
            catch { }
                                                    ...
                                                    DataGridViewDataErrorContexts context)
        {
            ...
            if (!IsDecimal(value) || (value == null || string.IsNullOrEmpty(formattedText)))
            {
                return baseFormattedValue;
            }

            decimal unformattedDecimal = Convert.ToDecimal(value); // 123.1 to "123.1"
            decimal formattedDecimal = Convert.ToDecimal(formattedText); // 123.1 to "123.12" if DecimalLength is 2
