...
namespace LBM
{
    public class StackedHeaderDecorator
    {
        ...
        private StackedHeader objHeaderTree;
        ...
        void ObjDataGrid_Paint(object sender, PaintEventArgs e)
        {
            ...
            objDataGrid.ColumnHeadersHeight = iNoOfLevels * 15;
        ...
        private void RenderColumnHeaders()
        {
            ...
            foreach (StackedHeader objChild in objHeaderTree.Children)
            {
        ...
        public void Render(StackedHeader objHeader)
        {
        ...
        private int NoOfLevels(StackedHeader header)
        {
            int level = 0;
            foreach (StackedHeader child in header.Children)
            {
