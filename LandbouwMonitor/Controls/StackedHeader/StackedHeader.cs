...
namespace LBM
{
    ...
    {
        public List<StackedHeader> Children { get; set; }
        ...
        {
            Name = string.Empty;
            Children = new List<StackedHeader>();
            ColumnId = -1;
        }
        ...
        public void Measure(DataGridView objGrid, int iY, int iHeight)
        {
            ...
            if (Children.Count > 0)
            {
                ...
                foreach (StackedHeader child in Children)
                {
        ...
        {
            foreach (StackedHeader objChild in Children)
            {
