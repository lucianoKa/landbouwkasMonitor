...
{
    public class ZonesMGV : KryptonDataGridView   // DataGridView
    {
        ...
        public ZonesMGV()
        {
            ...
            // Draw the "+" symbol
            RowPostPaint += ZonesMGV_RowPostPaint;
            ...
            CellMouseEnter += ZonesMGV_CellMouseEnter;

            // Clear cell when ESC is pressed
            CellEndEdit += ZonesMGV_CellEndEdit;

            // Disable Selection
            SelectionChanged += ZonesMGV_SelectionChanged;

            // Delete records or open details
            KeyDown += ZonesMGV_KeyDown;

            DatagridviewHelper.ApplyGridTheme(this);
        }

        void ZonesMGV_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ZonesMGV grid = (ZonesMGV)sender;

            // Clear the row error in case the user presses ESC.   
            grid.Rows[e.RowIndex].ErrorText = String.Empty;
        }

        private void ZonesMGV_SelectionChanged(object sender, EventArgs e)
        {
            ZonesMGV grid = (ZonesMGV)(sender);
            grid.ClearSelection();
        }

        void ZonesMGV_CurrentCellDirtyStateChanged(object sender, EventArgs e)
        {
        ...
        void ZonesMGV_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void ZonesMGV_CellMouseEnter(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void InitializeComponent()
        {
            ...
            ComponentResourceManager resources = new ComponentResourceManager(typeof(ZonesMGV));
        ...
        private void ZonesMGV_RowPostPaint(object sender, DataGridViewRowPostPaintEventArgs e)
        {
