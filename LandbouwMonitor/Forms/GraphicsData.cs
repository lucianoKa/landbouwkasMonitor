...
namespace LBM
{
    public partial class GraphicsData : KryptonForm
    {
        #region Constructor
        public GraphicsData()
        {
        ...
        private void FillGraphGewassen(List<EF.Gewas> gewassen)
        {
            ...
            switch ((Values)cbValues.SelectedValue)
            {
                ...
                case Values.Soil:
                    GraphCtrl.AddPointsSerie("PH", Axes.VerticalPrimary, "PH", Color.Green);
                    GraphCtrl.AddPointsSerie("Nitro", Axes.VerticalSecondary, "Stikstof", Color.Purple );
            ...
            foreach (var gewas in gewassen)
            {
                switch ((Values)cbValues.SelectedValue)
                {
                    ...
                    case Values.Moist:
                        ...
                        break;
                    case Values.Soil:
                        GraphCtrl.GetPointsSerie("PH").AddPointD(gewas.MeetDatum, (double)gewas.PH);
        ...
        private void FillGraphZone(List<EF.Gewas> gewassen1, List<EF.Gewas> gewassen2)
        {
            ...
            if (gewassen1 != null)
            {
                ...
                switch ((Values)cbValues.SelectedValue)
                {
                    ...
                    case Values.Soil:
                        //Gewas1
                        GraphCtrl.AddPointsSerie("PH1", Axes.VerticalPrimary, "PH - " + gewasNaam1, Color.Green);
                ...
                foreach (var gewas in gewassen1)
                {
                    switch ((Values)cbValues.SelectedValue)
                    {
                        ...
                        case Values.Moist:
                            ...
                            break;
                        case Values.Soil:
                            GraphCtrl.GetPointsSerie("PH1").AddPointD(gewas.MeetDatum, (double)gewas.PH);
            ...
            if (gewassen2 != null)
            {
                ...
                switch ((Values)cbValues.SelectedValue)
                {
                    ...
                    case Values.Soil:
                        GraphCtrl.AddPointsSerie("PH2", Axes.VerticalPrimary, "PH - " + gewasNaam2, Color.Blue);
                ...
                foreach (var gewas in gewassen2)
                {
                    switch ((Values)cbValues.SelectedValue)
                    {
                        ...
                        case Values.Moist:
                            ...
                            break;
                        case Values.Soil:
                            GraphCtrl.GetPointsSerie("PH2").AddPointD(gewas.MeetDatum, (double)gewas.PH);
